...
public class Translator {
    ...
    /**
     * Checks if all chars in the text are convertable into values. If key is
     * passed also checks whether length of key and text equal.
     * 
     * @param str
     *            - message/text
     * @param key
     ...
     *            - second char
     * @param operator
     *            - arithmetical operator used in transformation
    ...
    public char combine(char a, char b, char operator) {
        ...
        return operator == '+' ? intToChar(char1 + char2) : intToChar(char1
                - char2);
    }
